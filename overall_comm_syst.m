%{
created by: Rashad Fawzy 
last checked: 04/19/23
comments: missing a codec algorithm
%}

% % % bits to waveform % % % 
tx_msg = 'xoco'; % must be single quotation
SPB = 10; 
...
% % % waveform to bitseq % % %
rx_bs = waveform2bitseq(eq_wave,SPB,ch);
rx_bs(1 : length(tx_bs)) - tx_bs
